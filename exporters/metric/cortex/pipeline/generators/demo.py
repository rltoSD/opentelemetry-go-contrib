...
for i in range(100):
    ...
    f.write(f"isobs,{val*7},\"isob{i}, descr1, key1, value1\"\n")
    f.write(f"fsobs,{val*8},\"fsob{i}, descr1, key1, value1\"\n")
    f.write(f"ivobs,{val*9},\"ivob{i}, descr1, key1, value1\"\n")
    f.write(f"fvobs,{val*10},\"fvob{i}, descr1, key1, value1\"\n")
    f.write(f"iudobs,{val*11},\"iudob{i}, descr1, key1, value1\"\n")
    f.write(f"fudobs,{val*12},\"fudob{i}, descr1, key1, value1\"\n")
f.close()
